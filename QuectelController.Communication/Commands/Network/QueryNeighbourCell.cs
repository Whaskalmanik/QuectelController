...
{
    public class QueryNeighbourCellInformation : CommandBase
    {
        ...
        public override string Name => "Query Neighbour Cell Information";
        ...
        {
            return RawCommand + "=\"neighbourcell\"," + CreateParametersString(commandParameters);
        }
    }
}
